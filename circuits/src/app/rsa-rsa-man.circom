...
template NopeRSARSAManaged() {
  ...
  component SLDDSVerify = VerifyDSSuffixFromHashRSA(MAX_RSA_SIG_LEN, MAX_RSA_KEY_LEN, 8);
...
component main { public[packed_pub_inputs] } = NopeRSARSAManaged();
