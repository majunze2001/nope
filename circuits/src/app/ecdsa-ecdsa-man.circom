...
template NopeECDSAECDSAManaged() {
  // standard constants
  ...
  component TLDKSKExtract = ExtractKSK(MAX_TLD_NAME_LEN, ECDSA_KEY_LEN, 13);
  ...
  component SLDDSVerify = VerifyDSSuffixFromHashECDSA(13);
...
component main { public[packed_pub_inputs] } = NopeECDSAECDSAManaged();
